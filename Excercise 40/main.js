/*
Question #40; Album:
          Write a function called make_album() that builds a Object describing a music album. The function should
...
*/
function make_album(Artist, Title, number_tracks) {
    let Album = { Artist, Title };
    if (number_tracks) {
        let Album = number_tracks;
        console.log(`${Artist},${Title},${number_tracks}`);
    }
    return Album;
}
(make_album("Artist 1", "Album 1", 4));
(make_album("Artist 2", "Album 2", 9));
(make_album("Artist 3", "Album 3", 13));
export {};
