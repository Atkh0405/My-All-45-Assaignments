...
*/
function Car_Info(manufacturer:string,model_Name:string, ...extraoption:{ [key:string]:any}[]) {
    let CarInfo={
      manufacturer,
      model_Name,
  ...
  console.log(
   Car_Info("Haonda","Civic", {color:"Black"},{features:["Sunroof","Electronic Parking Brakes","Parking Sensors"]}));
